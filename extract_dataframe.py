...
class TweetDfExtractor:
    ...
    def find_source(self)->list:
        ...
        for txt in self.tweets_list:
            source.append(txt['source'])
        return source

    def find_screen_name(self)->list:
        screen_name = []
        for nm in self.tweets_list:
            screen_name.append(nm['user']['screen_name'])
        return screen_name

    def find_followers_count(self)->list:
        followers_count = []
        for f in self.tweets_list:
            followers_count.append(f['user']['followers_count'])
        return followers_count

    def find_friends_count(self)->list:
        friends_count = []
        for f in self.tweets_list:
            friends_count.append(f['user']['friends_count'])
    ...
    def find_hashtags(self)->list:
        ...
        for h in self.tweets_list:
            hashtags.append(h['entities']['hashtags'])
        return hashtags

    def find_mentions(self)->list: 
        mentions = []
        for f in self.tweets_list:
            mentions.append(f['entities']['user_mentions'] for m in self.tweets_list)
        return mentions  
    ...
    def get_tweet_df(self, save=False)->pd.DataFrame:
        ...
        # columns = ['created_at', 'source', 'original_text','clean_text', 'sentiment','polarity','subjectivity', 'lang', 'favorite_count', 
